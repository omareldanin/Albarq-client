...
export const EditOrder = () => {
    ...
    const {
        ...
        isError
    } = useOrderDetails(Number.parseInt(id));
        ...
        <AppLayout isLoading={isFetchingProduct} isError={isError}>
            ...
            <form onSubmit={form.onSubmit(handleEditOrder)}>
                ...
                <Grid gutter="lg">
                    ...
                    <Grid.Col span={{ base: 12, md: 6, lg: 6, sm: 12, xs: 12 }}>
                        <Textarea label="الملاحظات" {...form.getInputProps("notes")} rows={7} maxRows={10} />
                    </Grid.Col>
                    <Grid.Col span={{ base: 12, md: 6, lg: 6, sm: 12, xs: 12 }}>
                        <Textarea label="التفاصيل" {...form.getInputProps("details")} rows={7} maxRows={10} />
                    </Grid.Col>
                    <Grid.Col span={{ base: 12, md: 6, lg: 6, sm: 12, xs: 12 }}>
                        <Button
                            loading={isLoading}
