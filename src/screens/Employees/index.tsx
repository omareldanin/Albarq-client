...
import { type permissionsArabicNames, permissionsArray } from "@/lib/persmissionArabicNames";
import { type rolesArabicNames, rolesArray } from "@/lib/rolesArabicNames";
import { Accordion, Grid, LoadingOverlay, MultiSelect, Select, TextInput } from "@mantine/core";
...
export const Employees = () => {
    ...
    const handleChangePermissions = (value: (keyof typeof permissionsArabicNames)[]) => {
        setFilters({
            ...filters,
            permissions: value
        });
                        ...
                        <Grid className="mt-4 my-10">
                            <Grid.Col span={{ base: 12, sm: 12, xs: 12, md: 6, lg: 6 }}>
                                <MultiSelect
                                    ...
                                    placeholder="الدور"
                                    value={filters.roles}
                                    onChange={(e) => handleSelect(e as (keyof typeof rolesArabicNames)[])}
                                />
                            </Grid.Col>
                            <Grid.Col span={{ base: 12, sm: 12, xs: 12, md: 6, lg: 6 }}>
                                <MultiSelect
                                    ...
                                    onChange={(e) =>
                                        handleChangePermissions(e as (keyof typeof permissionsArabicNames)[])
                                    }
                                />
                            </Grid.Col>
                            <Grid.Col span={{ base: 12, sm: 12, xs: 12, md: 6, lg: 6 }}>
