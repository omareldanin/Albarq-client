...
export const BulkOrdersItem = ({
            ...
            return (
                <Group style={{ width: rem(280) }} key={phone.key}>
                    <TextInput
                        ...
                        withAsterisk
                        style={{ flex: 1 }}
                        {...form.getInputProps(`orders.${index}.recipientPhones.${phoneArrayIndex}.phone`)}
                    ...
                    <ActionIcon
                        ...
                        onClick={() => {
                            if (form.values.orders[index].recipientPhones.length > 1) {
                                form.removeListItem(`orders.${index}.recipientPhones`, phoneArrayIndex);
                            }
                        }}
                        className="mt-6"
                    >
    ...
    const productsItems = form.values.orders[index]?.products?.map((product, productsIndex) => {
        return (
            <div
            ...
            >
                <TextInput
                    ...
                    size="xs"
                    className="w-full"
                    {...form.getInputProps(`orders.${index}.products.${productsIndex}.label`)}
                    disabled
                />
                <TextInput
                    label="الكمية"
                    ...
                    size="xs"
                    className="w-full"
                    {...form.getInputProps(`orders.${index}.products.${productsIndex}.quantity`)}
                />
                <Select
                    searchable
                    size="xs"
                    ...
                    limit={100}
                    {...form.getInputProps(`orders.${index}.products.${productsIndex}.colorID`)}
                />
                <Select
                    searchable
                    size="xs"
                    ...
                    limit={100}
                    {...form.getInputProps(`orders.${index}.products.${productsIndex}.sizeID`)}
                />
            </div>
        );
    });
        ...
        >
            ...
            <div className="flex items-center gap-4">
                ...
                <Switch
                    ...
                    onChange={(e) => {
                        form.setFieldValue(`orders.${index}.orderDelivery`, e.target.checked);
                    }}
                />
            </div>
            <Grid grow gutter="lg">
                ...
                <Grid.Col span={{ base: 12, md: 6, lg: 2, xl: 2, sm: 12, xs: 12 }}>{numberFields}</Grid.Col>
                <Grid.Col span={{ base: 12, md: 6, lg: 2, xl: 2, sm: 12, xs: 12 }}>
                    <Textarea
                        label="الملاحظات"
                        ...
                        <Grid.Col span={{ base: 12, md: 12, lg: 12, sm: 12, xs: 12 }}>
                            <MultiSelect
                                ...
                                onChange={(selectedProductsIds) => {
                                    ...
                                    form.setFieldValue(`orders.${index}.products`, productsLabels);
                                }}
