...
export const columns: ColumnDef<IDeliveryAgentManifest>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            const { orders_end_date, orders_start_date, branch_id } = useManifestStore();
            const handleClick = () => {
                navigation("/orders", {
                    state: {
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            const { mutateAsync: crateDeliveryAgentManifest, isLoading } = useCreateReportsDocumentation();
            ...
            return (
                <Button onClick={handleCreateDeliveryAgentManifest} disabled={isLoading || !hasOrders}>
                    تحميل مانفيست
                </Button>
            );
        }
