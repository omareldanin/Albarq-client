...
export const initialReportOrderStatuses = ["DELIVERED", "PARTIALLY_RETURNED", "REPLACED"];

export const repositoryReportsOrderStatuses = ["PARTIALLY_RETURNED", "REPLACED", "RETURNED"];
